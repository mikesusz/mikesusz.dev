...
[^Mosaic]: [NCSA Mosaic](https://en.wikipedia.org/wiki/NCSA_Mosaic) was the first widely-used graphical browser for the web, followed very quickly by the rest of this list. Wired does well to espouse on its effects [in this article](https://www.wired.com/2010/04/0422mosaic-web-browser/)
...
[^WAP]: In the days before smartphones, the mobile phone data landscape was bleak. [WAP](https://en.wikipedia.org/wiki/Wireless_Application_Protocol) was a promising development, but device capabilities and network capacity expanded quickly enough that WAP became unnecessary. thankfully. It was rough, y'all.

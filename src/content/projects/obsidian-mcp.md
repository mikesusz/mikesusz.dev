...
description: 'A local MCP Server to make your Obsidian notes available to your AI assistant'
createdDate: 'March 2026'
status: 'active'
tags: ['python']
repoUrl: 'https://github.com/mikesusz/obsidian-mcp'
draft: false
---
...
GNU Affero General Public License v3.0 — see [LICENSE](https://github.com/mikesusz/obsidian-mcp/blob/main/LICENSE) for the full text.

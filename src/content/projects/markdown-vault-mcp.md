---
title: 'Markdown Vault MCP Server'
description: 'A local MCP Server to make your markdown files available to your AI assistant'
createdDate: 'March 2026'
status: 'active'
tags: ['python']
repoUrl: 'https://github.com/mikesusz/markdown-vault-mcp'
draft: false
---
